...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-crawler-js/node_modules/crawler-js/lib/random_agent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-crawler-js/node_modules/crawler-js/lib/random_agent.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-crawler-js/node_modules/crawler-js/lib/</a> &#187; random_agent.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var agents = {</span>
    Internet_Explorer:[
...
<span class="cstat-no" title="statement not covered" >  var sortBrowser = browsers[Math.floor(Math.random() * browsers.length)];</span>
<span class="cstat-no" title="statement not covered" >  return agents[sortBrowser][Math.floor(Math.random() * agents[sortBrowser].length)];</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
